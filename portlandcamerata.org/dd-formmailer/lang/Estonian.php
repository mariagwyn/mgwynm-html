...
define('DDFM_MAXCHARLIMIT', 'maksimaalne t&auml;htede arv');

define('DDFM_MISSINGFIELD', 'N&otilde;utud v&auml;li t&auml;itmata: ');

define('DDFM_INVALIDINPUT', 'Ebakorrektselt t&auml;idetud ');

define('DDFM_INVALIDEMAIL', 'Ebakorrektne e-maili aadress');

define('DDFM_INVALIDURL', 'Ebakorrektne URL ');

define('DDFM_NOMATCH', 'V&auml;ljad ei klapi ');
...
define('DDFM_MISSINGFILE', 'N&otilde;utud fail puudu');
...
define('DDFM_UPLOADERR', '&Uuml;leslaadimise viga:');
