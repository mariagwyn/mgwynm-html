...
$script_path = 'http://portlandcamerata.org/dd-formmailer/dd-formmailer.php';
...
$path_contact_page = 'http://portlandcamerata.org/contact.php';
...
$recipients = 'to=suehmcd@gmail.com|cc=jglassel@gmail.com';
...
$form_struct = '
	...
	type=widetextarea|class=fmtextwide|label=Message|fieldname=fm_message|max=1000|rows=6|req=true
...
$email_subject = 'Portland Camerata Website Contact: fm_subject';
...
/* Generate the script output */
	...
	if (!$message_sent) {	
		...
		if (trim($manual_form_code) == '') {	// ** Use normal form generation
			...
			$o .= '<div class="submit"><input type="submit" id="submit-button" name="form_submitted" value="' . DDFM_SUBMITBUTTON . '" /></div>' . "\n\n";
